...
public class ClienteTest {
	...
	public void test1CriarCliente() {
		...
		String vanessa = "{\"id\" : \"1\", \"name\":\"vanessa\", \"telefone\" : \"40028922\","
				...
				+ " \"cpf\" : \"1234-5678\", \"servico\" : \"Programa\"}";

		String hugo = "{\"id\" : \"2\", \"name\":\"hugo\","
				+ "\"telefone\" : \"40028922\", \"email\" : \"hugo@email.com\","
				+ "\"endereco\" : \"80\", \"dataNascimento\" : \"20 de Maio de 1998\", \"cpf\" : \"1234-5678\", \"servico\" : \"Web service\"}";
		...
		.body("servico", containsString("Programa"));
		...
		.body("dataNascimento", containsString("20 de Maio de 1998"))
		.body("cpf", containsString("1234-5678"))
		.body("servico", containsString("Web service"));
	...
	public void test5MudarCliente() {
		...
		String alisson = "{\"id\" : \"1\", \"name\":\"alisson\","
				...
				+ "\"endereco\" : \"80\", \"dataNascimento\" : \"20 de Maio de 1998\", \"cpf\" : \"1234-5678\", \"servico\" : \"app android\"}";
		...
		.body("dataNascimento", containsString("20 de Maio de 1998"))
		.body("cpf", containsString("1234-5678"))
		.body("servico", containsString("app android"));
